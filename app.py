...
#####################################################################################################
	...
	def json():
		nama_data_x = df5["Nama Data"].values.tolist()
		waktu_x = df5["Waktu"].values.tolist()
		nilai_x = df5["Nilai"].values.tolist()
		nama_produk_x = df5["Nama Produk"].values.tolist()
		item_x = df5["Item"].values.tolist()
		negara_x = df5["Negara"].values.tolist()
		provinsi_x = df5["Provinsi"].values.tolist()
		kota_x = df5["Kota"].values.tolist()
		satuan_x = df5["Satuan"].values.tolist()

		jsonx = {}
		jsonx["Nama Data"] = nama_data_x
		jsonx["Waktu"] = waktu_x
		jsonx["Nilai"] = nilai_x
		jsonx["Nama Produk"] = nama_produk_x
		jsonx["Item"] = item_x
		jsonx["Negara"] = negara_x
		jsonx["Provinsi"] = provinsi_x
		jsonx["Kota"] = kota_x
		jsonx["Satuan"] = satuan_x

		jsonxy = jsonify({'Output' : jsonx})

		return jsonxy

	def json2():
		nama_data_x = df4["Nama Data"].values.tolist()
		waktu_x = df4["Waktu"].values.tolist()
		nilai_x = df4["Nilai"].values.tolist()
		nama_produk_x = df4["Nama Produk"].values.tolist()
		item_x = df4["Item"].values.tolist()
		negara_x = df4["Negara"].values.tolist()
		provinsi_x = df4["Provinsi"].values.tolist()
		kota_x = df4["Kota"].values.tolist()
		satuan_x = df4["Satuan"].values.tolist()
	...
	#untuk if column -> row -> sort -> limit, memakai pola json3() sebab if column itu memotong jumlah kolom
	#sehingga harus tahu berapa kolom yg dipotong

	def json3():
		if len(tampung) == 1:

			tampung_1 = df5[tampung[0]].values.tolist()
			
			jsonx = {}
			jsonx[tampung[0]] = tampung_1
			...
			tampung_1 = df5[tampung[0]].values.tolist()
			tampung_2 = df5[tampung[1]].values.tolist()
			
			jsonx = {}
			jsonx[tampung[0]] = tampung_1
			jsonx[tampung[1]] = tampung_2
			...
			tampung_1 = df5[tampung[0]].values.tolist()
			tampung_2 = df5[tampung[1]].values.tolist()
			tampung_3 = df5[tampung[2]].values.tolist()
			
			jsonx = {}
			jsonx[tampung[0]] = tampung_1
			jsonx[tampung[1]] = tampung_2
			jsonx[tampung[2]] = tampung_3
			...
			tampung_2 = df5[tampung[1]].values.tolist()
			tampung_3 = df5[tampung[2]].values.tolist()
			tampung_4 = df5[tampung[3]].values.tolist()
			
			jsonx = {}
			jsonx[tampung[0]] = tampung_1
			jsonx[tampung[1]] = tampung_2
			jsonx[tampung[2]] = tampung_3
			jsonx[tampung[3]] = tampung_4
			...
			tampung_3 = df5[tampung[2]].values.tolist()
			tampung_4 = df5[tampung[3]].values.tolist()
			tampung_5 = df5[tampung[4]].values.tolist()
			...
			tampung_4 = df5[tampung[3]].values.tolist()
			tampung_5 = df5[tampung[4]].values.tolist()
			tampung_6 = df5[tampung[5]].values.tolist()
			...
			tampung_5 = df5[tampung[4]].values.tolist()
			tampung_6 = df5[tampung[5]].values.tolist()
			tampung_7 = df5[tampung[6]].values.tolist()
			...
			tampung_6 = df5[tampung[5]].values.tolist()
			tampung_7 = df5[tampung[6]].values.tolist()
			tampung_8 = df5[tampung[7]].values.tolist()
			...
			tampung_7 = df5[tampung[6]].values.tolist()
			tampung_8 = df5[tampung[7]].values.tolist()
			tampung_9 = df5[tampung[8]].values.tolist()
